...
import { calculateHuntRanking, type HuntEventRecord, type HuntSubmissionRecord } from "@/lib/hunt";
...
export default async function HuntAdminPage() {
  ...
  return <>
    ...
    <main className="inner hunt-admin-page">
      <HuntAdminClient event={event} submissions={rows} ranking={ranking} canConfigure={canConfigure} canReview={canReview} />
    </main>
    <SiteFooter />
  </>;
}
